...
TEST(SerArrayTestString, JsonArrayEmpty)
{
    std::string         stream("[]");
...
TEST(SerArrayTestString, JsonArrayOfIntSerialize)
{
...
TEST(SerArrayTestString, JsonArrayOfIntDeSerialize)
{
...
TEST(SerArrayTestString, BsonArrayEmpty)
{
    //NOTE INPUT ("[]");
...
TEST(SerArrayTestString, BsonArrayOfIntSerialize)
{
    std::array<int,12>  data{1,2,3,4,5,6,7,8,101,102,9,10};
...
TEST(SerArrayTestString, BsonArrayOfIntDeSerialize)
{
    std::array<int,12>  data;
    static const char inputRaw[]
            = "\x5B\x00\x00\x00"
