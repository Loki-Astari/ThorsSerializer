...
TEST(ReferenceWrapperTestString, JsonSimpleWrapperRead)
{
    bool                        import = false;
    int                         value = 0;
    ReferenceWrapperTest<int>   wrapper(value);
    std::string                 stream(R"({"data":12})");
...
TEST(ReferenceWrapperTestString, JsonComplexWrapperRead)
{
    bool                            import = false;
    Marker                          value{8, "Bob"};
    ReferenceWrapperTest<Marker>    wrapper(value);
    std::string                 stream(R"({"data":{"value":13,"data":"A string"}})");
...
TEST(ReferenceWrapperTestString, YamlnSimpleWrapperRead)
{
    bool                        import = false;
    int                         value = 9;
    ReferenceWrapperTest<int>   wrapper(value);
...
TEST(ReferenceWrapperTestString, YamlnComplexWrapperRead)
{
    bool                            import = false;
    Marker                          value{8, "Bob"};
    ReferenceWrapperTest<Marker>    wrapper(value);
...
TEST(ReferenceWrapperTestString, BsonSimpleWrapperRead)
{
...
TEST(ReferenceWrapperTestString, BsonComplexWrapperRead)
{
    using namespace std::string_literals;
    bool                            import = false;
    Marker                         value{0, "Bob"};
...
TEST(ReferenceWrapperTestString, JsonSimpleWrapperWrite)
{
    bool                        import = false;
    int                         value = 12;
    ReferenceWrapperTest<int>   wrapper(value);
