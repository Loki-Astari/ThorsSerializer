...
TEST(ExamplesTestString, TrivialExample0)
{
    std::vector<int>    data;
...
TEST(ExamplesTestString, SimpleExample1)
{
    using ThorsAnvil::Serialize::jsonImporter;
    using ThorsAnvil::Serialize::jsonExporter;
...
TEST(ExamplesTestString, BiggerExample2)
{
    using ThorsAnvil::Serialize::jsonExporter;
...
TEST(ExamplesTestString, Exampl4)
{
...
TEST(ExamplesTestString, Example6)
{
    using ThorsAnvil::Serialize::jsonExporter;
    using ThorsAnvil::Serialize::OutputType;
...
TEST(ExamplesTestString, Example7)
{
    using ThorsAnvil::Serialize::jsonImporter;
    using ThorsAnvil::Serialize::jsonExporter;
...
TEST(ExamplesTestString, Example8)
{
    using ThorsAnvil::Serialize::jsonImporter;
    using ThorsAnvil::Serialize::jsonExporter;
...
TEST(ExamplesTestString, ExampleE)
{
    using ThorsAnvil::Serialize::jsonImporter;
    using ThorsAnvil::Serialize::jsonExporter;
    using ThorsAnvil::Serialize::OutputType;
