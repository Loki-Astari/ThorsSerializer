...
TEST(SerListTestString, JsonArrayEmpty)
{
    std::string         stream("[]");
    std::list<int>      data;
...
TEST(SerListTestString, JsonListOfIntSerialize)
{
...
TEST(SerListTestString, JsonListOfIntDeSerialize)
{
    std::list<int>    data;
...
TEST(SerListTestString, BsonArrayEmpty)
{
    //NOTE INPUT ("[]");
...
TEST(SerListTestString, BsonListOfIntSerialize)
{
    std::list<int>      data{1,2,3,4,5,6,7,8,101,102,9,10};
...
TEST(SerListTestString, BsonListOfIntDeSerialize)
{
    std::list<int>    data;
