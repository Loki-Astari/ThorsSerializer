...
TEST(SerVectorTestString, JsonArrayEmpty)
{
    std::string         stream("[]");
    std::vector<int>    data;
...
TEST(SerVectorTestString, JsonVectorOfIntSerialize)
{
...
TEST(SerVectorTestString, JsonVectorOfIntDeSerialize)
{
    std::vector<int>    data;
...
TEST(SerVectorTestString, BsonArrayEmpty)
{
    //NOTE INPUT ("[]");
...
TEST(SerVectorTestString, BsonVectorOfIntSerialize)
{
    std::vector<int>    data{1,2,3,4,5,6,7,8,101,102,9,10};
...
TEST(SerVectorTestString, BsonVectorOfIntDeSerialize)
{
    std::vector<int>    data;
