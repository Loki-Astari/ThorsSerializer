...
{
    ThorsLogAndThrowError(std::runtime_error,
                          "ThorsAnvil::Serialize::DefaultCustomSerializer", "writeJson",
...
{
    ThorsLogAndThrowError(std::runtime_error,
                          "ThorsAnvil::Serialize::DefaultCustomSerializer", "readJson",
                          "Using an unimplemented translation:\n",
                          "This means you are a streaming a type you have marked with the macro: ThorsAnvil_MakeTraitCustomSerialize.\n",
...
{
    ThorsLogAndThrowError(std::runtime_error,
                          "ThorsAnvil::Serialize::DefaultCustomSerializer", "writeYaml",
                          "Using an unimplemented translation:\n",
                          "This means you are a streaming a type you have marked with the macro: ThorsAnvil_MakeTraitCustomSerialize.\n",
...
{
    ThorsLogAndThrowError(std::runtime_error,
                          "ThorsAnvil::Serialize::DefaultCustomSerializer", "readYaml",
                          "Using an unimplemented translation:\n",
                          "This means you are a streaming a type you have marked with the macro: ThorsAnvil_MakeTraitCustomSerialize.\n",
...
{
    ThorsLogAndThrowError(std::runtime_error,
                          "ThorsAnvil::Serialize::DefaultCustomSerializer", "writeBson",
                          "Using an unimplemented translation:\n",
                          "This means you are a streaming a type you have marked with the macro: ThorsAnvil_MakeTraitCustomSerialize.\n",
...
{
    ThorsLogAndThrowError(std::runtime_error,
                          "ThorsAnvil::Serialize::DefaultCustomSerializer", "readBson",
                          "Using an unimplemented translation:\n",
                          "This means you are a streaming a type you have marked with the macro: ThorsAnvil_MakeTraitCustomSerialize.\n",
