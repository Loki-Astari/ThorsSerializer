#ifndef THORSANVIL_SERIALIZATION_CUSTOM_SERIALIZATION_TPP
#define THORSANVIL_SERIALIZATION_CUSTOM_SERIALIZATION_TPP
...
void DefaultCustomSerializer<T>::writeCustom(PrinterInterface& printer, T const& object) const
{
    switch (printer.formatType())
    {
        ...
        default:
        {
            ThorsLogAndThrowError("ThorsAnvil::Serialize::DefaultCustomSerializer<T>",
                                  "writeCustom",
...
{
    ThorsLogAndThrowError("ThorsAnvil::Serialize::DefaultCustomSerializer", "writeJson",
...
{
    ThorsLogAndThrowError("ThorsAnvil::Serialize::DefaultCustomSerializer", "readJson",
                          "Using an unimplemented translation:\n",
                          "This means you are a streaming a type you have marked with the macro: ThorsAnvil_MakeTraitCustomSerialize.\n",
...
{
    ThorsLogAndThrowError("ThorsAnvil::Serialize::DefaultCustomSerializer", "writeYaml",
                          "Using an unimplemented translation:\n",
                          "This means you are a streaming a type you have marked with the macro: ThorsAnvil_MakeTraitCustomSerialize.\n",
...
{
    ThorsLogAndThrowError("ThorsAnvil::Serialize::DefaultCustomSerializer", "readYaml",
                          "Using an unimplemented translation:\n",
                          "This means you are a streaming a type you have marked with the macro: ThorsAnvil_MakeTraitCustomSerialize.\n",
...
{
    ThorsLogAndThrowError("ThorsAnvil::Serialize::DefaultCustomSerializer", "getPrintSizeBson",
                          "Using an unimplemented translation:\n",
                          "This means you are a streaming a type you have marked with the macro: ThorsAnvil_MakeTraitCustomSerialize.\n",
...
{
    ThorsLogAndThrowError("ThorsAnvil::Serialize::DefaultCustomSerializer", "writeBson",
                          "Using an unimplemented translation:\n",
                          "This means you are a streaming a type you have marked with the macro: ThorsAnvil_MakeTraitCustomSerialize.\n",
...
{
    ThorsLogAndThrowError("ThorsAnvil::Serialize::DefaultCustomSerializer", "readBson",
                          "Using an unimplemented translation:\n",
                          "This means you are a streaming a type you have marked with the macro: ThorsAnvil_MakeTraitCustomSerialize.\n",
