...
struct HeedAllValues
{
    ...
    int checkAMember(KeyStore const& membersFound, std::pair<std::string_view, X> const& member)
    {
        ...
        {
            ThorsLogAndThrowDebug("ThorsAnvil::Serialize::HeedAllValues",
                                  "checkAMember"
...
class DeSerializationForBlock
{
    ...
    public:
            ...
            , parser(parser)
        {
            ...
            {
                ThorsLogAndThrowDebug("ThorsAnvil::Serialize::DeSerializationForBlock<Map>",
                                      "DeSerializationForBlock",
...
class DeSerializationForBlock<TraitType::Value, T>
{
    ...
    public:
        ...
        void scanObject(T& object)
        {
            ...
            {
                ThorsLogAndThrowDebug("ThorsAnvil::Serialize::DeSerializationForBlock<Value>",
                                       "DeSerializationForBlock",
                                       "Invalid Object");
            }
...
DeSerializationForBlock<TraitType::Custom_Depricated, T>
{
    ...
    public:
        ...
        void scanObject(T& object)
        {
            ...
            if (tokenType != ParserToken::Value)
            {
                ThorsLogAndThrowDebug("ThorsAnvil::Serialize::DeSerializationForBlock<Serialize>",
                                      "DeSerializationForBlock",
                                      "Invalid Object");
            }
...
auto tryParsePolyMorphicObject(DeSerializer& parent, ParserInterface& parser, T& object, int) -> decltype(object->parsePolyMorphicObject(parent, parser), void())
{
    ...
    if (tokenType != ParserToken::MapStart)
    {
        ThorsLogAndThrowDebug("ThorsAnvil::Serialize",
...
class DeSerializationForBlock<TraitType::Enum, T>
{
    ...
    public:
        ...
        void scanObject(T& object)
        {
            ...
            if (tokenType != ParserToken::Value)
            {
                ThorsLogAndThrowDebug("ThorsAnvil::Serialize::DeSerializationForBlock<Enum>",
                                      "DeSerializationForBlock",
                                      "Invalid Object");
            }
...
class DeSerializationForBlock<TraitType::Array, T>
{
    ...
    public:
            ...
            , index(-1)
        {
            ...
            {
                ThorsLogAndThrowDebug("ThorsAnvil::Serialize::DeSerializationForBlock<Array>",
                                      "DeSerializationForBlock",
                                      "Invalid Object Start");
            }
        }
