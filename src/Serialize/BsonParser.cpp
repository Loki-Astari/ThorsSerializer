...
void BsonParser::ignoreDataValue()
{
    ...
    switch (nextType)
    {
        ...
        */
        case '\x01':    ignore(8);   dataLeft.back() -= 8;   ThorsLogNotice("ThorsAnvil::Serialize::BsonParser", "ignoreDataValue", "Double-64");   break;
        case '\x13':    ignore(16);  dataLeft.back() -= 16;  ThorsLogNotice("ThorsAnvil::Serialize::BsonParser", "ignoreDataValue", "Double-128");  break;
        case '\x10':    ignore(4);   dataLeft.back() -= 4;   ThorsLogNotice("ThorsAnvil::Serialize::BsonParser", "ignoreDataValue", "Int-32");      break;
        case '\x12':    ignore(8);   dataLeft.back() -= 8;   ThorsLogNotice("ThorsAnvil::Serialize::BsonParser", "ignoreDataValue", "Int-64");      break;
        case '\x07':    ignore(12);  dataLeft.back() -= 12;  ThorsLogNotice("ThorsAnvil::Serialize::BsonParser", "ignoreDataValue", "Obj-ID");      break;
        case '\x08':    ignore(1);   dataLeft.back() -= 1;   ThorsLogNotice("ThorsAnvil::Serialize::BsonParser", "ignoreDataValue", "Bool");        break;
        case '\x09':    ignore(8);   dataLeft.back() -= 8;   ThorsLogNotice("ThorsAnvil::Serialize::BsonParser", "ignoreDataValue", "UTC DateTime");break;
        case '\x11':    ignore(8);   dataLeft.back() -= 8;   ThorsLogNotice("ThorsAnvil::Serialize::BsonParser", "ignoreDataValue", "TimeStamp");   break;
        case '\x0A':                                         ThorsLogNotice("ThorsAnvil::Serialize::BsonParser", "ignoreDataValue", "NULL");        break;
        case '\x02':
        {
            std::int32_t size;
            ...
            ThorsLogNotice("ThorsAnvil::Serialize::BsonParser", "ignoreDataValue", "String");
            break;
        }
        case '\x05':
        {
            ...
            ThorsLogNotice("ThorsAnvil::Serialize::BsonParser", "ignoreDataValue", "Binary");
            break;
        }
        default:
        {
